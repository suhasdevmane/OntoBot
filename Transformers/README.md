...
- Health: `GET /health`
- Model: `Transformers/t5_base/trained/checkpoint-3` (Download the files from Huggingface [suhasdevmane/nl2sparql-brick-t5-base](https://huggingface.co/suhasdevmane/nl2sparql-brick-t5-base/tree/main) or search repository suhasdevmane/nl2sparql-brick on Huggingface)
